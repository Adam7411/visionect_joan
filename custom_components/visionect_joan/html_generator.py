...
async def _add_interactive_layer_to_url(
    ...
    try:
        ...
        *, *:before, *:after {{ box-sizing: inherit; }}
        ...
        interactive_scripts = ""
        js_needs_navigate = (has_back_button) or (click_anywhere and back_url) or (auto_return_seconds and back_url and (has_back_button or click_anywhere))
        ...
        if auto_return_seconds and auto_return_seconds > 0:
            ...
            elif back_url and (has_back_button or click_anywhere):
