...
def create_calendar_url(events: list, style: str = "modern", lang: str = "en", screen_size: str = "joan6") -> str:
    ...
    if style == "modern":
        style_css = f"""
            ...
            .date-header {{ text-align: center; font-size: {_sem(2.2)}; font-weight: bold; border-bottom: {_spx(3)} solid black; padding-bottom: 8px; margin-top: 15px; margin-bottom: 15px; }}
            .event {{ display: flex; margin-bottom: 12px; padding: 10px; border-left: {_spx(5)} solid black; background-color: #f9f9f9; }}
            .time {{ font-weight: bold; font-size: {_sem(1.5)}; flex: 0 0 {_spx(150)}; }}
            ...
            .description {{ margin-top: 5px; font-size: {_sem(1.2)}; color: #222; white-space: pre-wrap; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }}
            .no-events {{ text-align: center; font-size: {_sem(2.2)}; padding-top: 60px; }}
        """
    else: # minimalist
...
def create_monthly_calendar_url(year: int, month: int, events: list, lang: str = "en", screen_size: str = "joan6") -> str:
    ...
    style_css = f"""
        ...
        .back-button {{ font-size: {_sem(3.5)}; text-decoration: none; color: black; position: absolute; top: 15px; left: 15px; cursor: pointer; z-index: 1001; padding: 15px 30px; }}
