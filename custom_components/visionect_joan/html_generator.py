...
async def create_crypto_panel_url(
    ...
    title_text = "Kryptowaluty" if pl else "Crypto"
    updated_text = "Aktualizacja" if pl else "Updated"
    ...
    for coin in coins:
        ...
        if history and len(history) >= 2:
            ...
            if h24 and l24:
                ...
                fallback_text = "Brak wykresu" if pl else "No chart data"
...
async def create_exchange_rates_url(
    ...
    if not title:
        title = "Kursy walut" if pl else "Exchange Rates"
    updated_text = "Aktualizacja" if pl else "Updated"
...
"""
    ...
    for pair in pairs:
        ...
        if history and len(history) >= 2:
            ...
            fallback_text = "Brak hist." if pl else "No hist."
