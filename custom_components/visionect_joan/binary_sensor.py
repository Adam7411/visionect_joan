# custom_components/visionect_joan/binary_sensor.py
import logging
...
# Definicje sensorów binarnych
# Format: (DeviceClass, Ikona, Domyślnie włączony)
BINARY_SENSOR_TYPES = {
...
async def async_setup_entry(
    ...
    """Konfiguracja sensorów binarnych."""
...
class VisionectBinarySensor(VisionectEntity, BinarySensorEntity):
    """Sensor binarny dla urządzenia Visionect."""
    ...
    def is_on(self) -> bool | None:
        ...
        if self.sensor_type == "is_charging":
            # POPRAWKA: Sprawdzamy pole "Charger". Zakładamy, że wartość '1' oznacza ładowanie.
