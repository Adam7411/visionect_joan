...
class VisionectEntity(CoordinatorEntity):
    ...
    def device_info(self) -> DeviceInfo:
        ...
        # Attempt to get hardware revision from Options
        hardware_revision = device_data.get("Options", {}).get("Revision")
        if not hardware_revision or hardware_revision.lower() in UNKNOWN_STRINGS:
            hardware_revision = MODEL_JOAN6
