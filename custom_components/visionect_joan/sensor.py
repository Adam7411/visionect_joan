...
class VisionectSensor(VisionectEntity, SensorEntity):
    ...
    def native_value(self):
        ...
        try:
            ...
            # ---> ZMIANA: Całkowicie nowa, ulepszona logika dla sensora URL <---
    ...
    # ---> ZMIANA: Uproszczona logika atrybutów, która zawsze przechowuje pełny URL <---
    @property
    def extra_state_attributes(self):
        ...
        if self.sensor_type == "configured_url":
            ...
            if full_url and full_url.lower() not in UNKNOWN_STRINGS:
