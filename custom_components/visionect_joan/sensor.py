...
# ---> NEW: We define the maximum length for the displayed URL <---
...
class VisionectSensor(VisionectEntity, SensorEntity):
        ...
        try:
            ...
            if self.sensor_type == "configured_url":
                ...
                if url.startswith("data:text/html,"):
                    # <-- CHANGE: Use universal English terms -->
            ...
            # <--- NOWA LOGIKA DLA SENSORÓW DIAGNOSTYCZNYCH --->
    ...
    def extra_state_attributes(self):
        ...
        if self.sensor_type == "configured_url":
            ...
            # <-- CHANGE: Add a condition to not save huge 'data:' URLs -->
