...
# ---> ZMIANA: Dodano nową opcję 'image_bottom' <---
# Opcje layoutu
...
# ZMIANA W TEJ FUNKCJI (dodano obsługę layout='image_bottom')
def create_text_message_url(message: str, text_color: str = "black",
    ...
    # ---> ZMIANA: Dodano warunek dla 'image_bottom' <---
    flex_direction = "column" # Domyślny dla image_top
