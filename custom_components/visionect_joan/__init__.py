...
SERVICE_SEND_SHOPPING_LIST = "send_shopping_list"
...
SERVICE_SEND_SHOPPING_LIST_SCHEMA = SERVICE_DEVICE_SCHEMA.extend({
    vol.Optional(ATTR_TITLE, default="Lista Zakupów"): cv.string,
})
...
async def create_energy_panel_url(hass: HomeAssistant, states: dict[str, State | None]) -> str:
    ...
    # ---> ZMIANA: Zaktualizowane style CSS dla panelu energetycznego <---
    style_css = """
        ...
        .main-stat .unit { 
            font-size: 0.3em; /* Stosunek rozmiaru do głównej liczby */
            font-weight: bold;
            opacity: 0.9;
            padding-top: 1em; /* Dopasowanie pionowe */
        }
