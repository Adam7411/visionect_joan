...
CONF_USE_WEB_INTERFACE = "use_web_interface"
...
API_REFRESH = "/api/device/{uuid}/refresh"
API_CLEAR = "/api/device/{uuid}/clear"
...
SELENIUM_TIMEOUT = 30  # Timeout dla operacji Selenium
WEBDRIVER_WAIT_TIME = 10  # Czas oczekiwania na elementy
