...
def _create_config_notification(hass: HomeAssistant):
    ...
    if is_pl:
        ...
        message = (
            "Aby dodać lub usunąć widoki używane w listach „Wybierz widok” i „Cel przycisku Wstecz”:\n\n"
            "1) Otwórz: Ustawienia → Urządzenia i usługi → Visionect Joan → Konfiguruj\n"
            "2) Wybierz: „Dodaj widok” lub „Usuń widok”\n"
            "3) Dodawanie: wpisz „Nazwa widoku” i „Adres URL” i zapisz\n"
            "4) Usuwanie: wybierz widok z listy i potwierdź\n\n"
            "Widoki zapisują się globalnie i będą dostępne na wszystkich urządzeniach Visionect w selektorach."
        )
    else:
        title = "Views configuration (Visionect Joan)"
        message = (
            "To add or remove views used by “Choose view” and “Back button target” lists:\n\n"
            "1) Go to: Settings → Devices & Services → Visionect Joan → Configure\n"
            "2) Choose: “Add view” or “Remove view”\n"
            "3) Adding: enter “View name” and “View URL”, then save\n"
            "4) Removing: pick a view from the list and confirm\n\n"
            "Views are saved globally and will be available for all Visionect devices in selectors."
        )
